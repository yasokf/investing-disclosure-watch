...
export default function TanshinSummaryAnalysisPage() {
  ...
  return (
    <main style={{ padding: 24 }}>
      <h1>Tanshin Summary (Analysis)</h1>
      <p>このページは決算短信のサマリーと抽出結果を表示します。</p>
      <p style={{ marginTop: 8 }}>
        PDFをアップロードする場合は <Link href="/tanshin-upload">PDF取り込み</Link> を利用してください。
      </p>
      <p style={{ marginTop: 8 }}>
        KPIのみの一覧は <Link href="/tanshin-summary">Tanshin Summary</Link> を利用してください。
      </p>
